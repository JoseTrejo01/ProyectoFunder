        ...
        <div class="mb-3">
            ...
            <select name="beneficiario_id" id="beneficiario_id" class="form-control" required>
                ...
                @foreach($beneficiarios as $beneficiario)
                    <option value="{{ $beneficiario->id_Beneficiario }}" data-actividad="{{ $beneficiario->actividad_economica }}">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="plazo_meses" class="form-control" value="{{ old('plazo_meses') }}" required>
                    ...
                    {{-- Destino --}}
            <div class="mb-3">
                <label for="destino" class="form-label">Destino (Actividad Económica)</label>
                <input type="text" name="destino" id="destino" class="form-control" readonly required>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            beneficiarioSelect.addEventListener('change', function() {
                ...
                const actividad = selectedOption.getAttribute('data-actividad') || '';
                destinoInput.value = actividad;
            });

            // Si quieres que al cargar la página con old() o valor por defecto también se rellene
            if (beneficiarioSelect.value) {
                const selectedOption = beneficiarioSelect.options[beneficiarioSelect.selectedIndex];
                destinoInput.value = selectedOption.getAttribute('data-actividad') || '';
            }
        });
        </script>
